...
<!-- 我有话想对你说模块 -->
<div class="container py-5" id="encouragement">
    <h2 class="text-center section-title mb-4">我有话想对你说</h2>
    <div class="row">
        <div class="col-md-12 text-center">
            <p id="encouragementText" class="lead" style="display: none;">点击“你说吧”获得温暖的鼓励。</p >
            <button id="speakButton" class="btn btn-primary btn-lg">你说吧</button>
        </div>
    </div>
</div>
